...
class MathUtilsTest {
    ...
    void testIterableEquals() {
        ...
        List<Integer> expectedList = new ArrayList<>(Arrays.asList(2, 8, 13));
...
//	@Disabled
	...
	// Different use cases of assertAll and nested classes - Testing Vehicle
	// AssertAll - Below Addition Tests, where we need to check multiple aspects of single functionality
	// Nested Classes - Testing Vehicles different parts
	...
	class DummyTest {
	    ...
	    @Test
	    void test1() {
	        sharedVariable = 5; // Modify shared variable
	        assertEquals(5, sharedVariable); // Passes
	    }

	    @Test
	    void test2() {
	        assertEquals(5, sharedVariable); // Fails because sharedVariable is not reset
	    }
	}
